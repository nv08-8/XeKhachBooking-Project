        ...
        (errTrip, tripRows) => {
          ...
          conn.query(
            ...
            (errSeat, seatRows) => {
              ...
              conn.query(
                "INSERT INTO bookings (user_id, trip_id, seat_label, price_paid, status, created_at) VALUES (?, ?, ?, ?, 'confirmed', NOW())",
...
router.get("/bookings/my", (req, res) => {
  ...
  const sql = `
    SELECT b.id, b.seat_label, b.status, b.price_paid, b.created_at,
